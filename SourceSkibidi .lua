...
local Window = Fluent:CreateWindow({Title = "💩",SubTitle = "💩",TabWidth = 155,Size = UDim2.fromOffset(555, 320),Acrylic = false,Theme = "Dark",MinimizeKey = Enum.KeyCode.End})
...
ToggleButton.Image = "rbxassetid://114870670059785"
...
local Tabs = {
  ...
  Combat = Window:AddTab({Title = "play", Icon = "user"}),
  Settings = Window:AddTab({Title = "Cài Đặt", Icon = "rbxassetid://114870670059785"}),
  Main = Window:AddTab({Title = "Farm", Icon = "home"}),
  Melee = Window:AddTab({Title = "Võ Thuật", Icon = "rbxassetid://114870670059785"}),
  Quests = Window:AddTab({Title = "Vật Phẩm Cày", Icon = "rbxassetid://114870670059785"}),
  SeaEvent = Window:AddTab({Title = "Biển", Icon = "rbxassetid://114870670059785"}),
  Mirage = Window:AddTab({Title = "Đảo Bí Ẩn/V4", Icon = "rbxassetid://114870670059785"}),
  ...
  Misc = Window:AddTab({Title = "Linh Tinh", Icon = "rbxassetid://114870670059785"})
}
